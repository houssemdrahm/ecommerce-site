    ...
    <div class="container">
        ...
        <div class="table-container">
            <table class="table table-hover">
                ...
                <tbody>
                    <!-- Bouclez sur les utilisateurs ici -->
                    <tr>
                        <td>1</td>
                        <td>Utilisateur A</td>
                        <td>utilisateurA@example.com</td>
                        <td>Admin</td>
                        <td>
                            <a href="view_user.php?id=1" class="btn btn-info btn-sm">Voir</a>
                            <a href="edit_user.php?id=1" class="btn btn-warning btn-sm">Modifier</a>
                            <a href="delete_user.php?id=1" class="btn btn-danger btn-sm">Supprimer</a>
                        </td>
                    </tr>
                    <!-- Autres utilisateurs -->
                </tbody>
