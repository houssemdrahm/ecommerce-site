...
<div class="dashboard-content animate-dashboard">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="add_order.php" class="btn btn-primary">Ajouter une Commande</a>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>En cours</td>
                        <td>
                            <a href="view_order.php?id=1" class="btn btn-info btn-sm">Voir</a>
                            <a href="edit_order.php?id=1" class="btn btn-warning btn-sm">Modifier</a>
                            <a href="delete_order.php?id=1" class="btn btn-danger btn-sm">Supprimer</a>
                        </td>
                    </tr>
                    <!-- Autres commandes -->
                </tbody>
