...
<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="https://localhost:8443/ecommerce-site/auth/logout.php">Déconnexion</a>
            </li>
        </ul>
    </div>
</nav>
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Bienvenue, <?php echo htmlspecialchars($user['username']); ?>!</h2>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title">Informations de l'utilisateur</h5>
                    <p class="card-text"><strong>Nom d'utilisateur:</strong> <?php echo htmlspecialchars($user['username']); ?></p>
            ...
            <div class="card mb-4">
                <div class="card-body text-center">
                    ...
                    <a href="cart.php" class="btn btn-success mb-2">Voir votre panier</a>
                    <a href="product_list.php" class="btn btn-info">Voir les produits</a>
                </div>
            </div>
        </div>
    </div>
